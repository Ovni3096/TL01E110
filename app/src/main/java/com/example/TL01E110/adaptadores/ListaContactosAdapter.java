package com.example.TL01E110.adaptadores;
...
import com.example.TL01E110.R;
import com.example.TL01E110.VerActivity;
...
public class ListaContactosAdapter extends RecyclerView.Adapter<ListaContactosAdapter.ContactoViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactoViewHolder holder, int position) {
        ...
        holder.viewCorreo.setText(listaContactos.get(position).getPais());
    ...
    public class ContactoViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView viewNombre, viewTelefono, viewCorreo,viewNota;
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            viewCorreo = itemView.findViewById(R.id.viewPais);
