package com.example.TL01E110.db;
...
public class DbContactos extends DbHelper {
    ...
    public long insertarContacto(String nombre, String telefono, String pais, String nota) {
    ...
    public boolean editarContacto(int id, String nombre, String telefono, String pais, String nota) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', telefono = '" + telefono + "', pais = '" + pais + "', nota = '" + nota + "' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
